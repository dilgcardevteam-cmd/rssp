...
=======
                        <th class="px-3 py-2 text-[11px] font-semibold text-center w-[23%]">Plantilla Item No.</th>
                        <th class="px-3 ml-30 py-2 text-[11px] font-semibold text-center w-[30%]">Job Title</th>
                        <th class="px-3 py-2 text-[11px] font-semibold text-center w-[10%]">Monthly Salary</th>
                        <th class="px-3 py-2 text-[11px] font-semibold text-center w-[20%]">Closing Date</th>
