    ...
    <div style="max-width:640px;margin:0 auto;padding:32px 20px;">
        <div style="background:#ffffff;border:1px solid #e2e8f0;border-radius:18px;overflow:hidden;">
            ...
            <div style="padding:28px;">
                ...
                <p style="margin:0 0 16px;font-size:15px;line-height:1.7;">Your applicant record ({{ $applicantCode }}) has been marked for deletion.</p>
                ...
                <p style="margin:0;font-size:15px;line-height:1.7;">If the scheduled deletion is not cancelled before the deadline above, your applicant account and related records will be permanently removed from the system.</p>
            </div>
        </div>
    </div>
</body>
