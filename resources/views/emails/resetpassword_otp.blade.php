...
<body>
  ...
  <div class="container">
    ...
    <div class="banner">Reset Password One-Time Password (OTP)</div>

    <div class="content">
      <p>Hello!</p>
      <p>
        You requested to reset your password on
        <strong>DILG - CAR Recruitment Selection and Placement Portal</strong>.
        To continue, use the OTP below:
      </p>
