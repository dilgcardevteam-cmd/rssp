          ...
          <div class="grid grid-cols-1 md:grid-cols-2 mobile-grid gap-4">
            <div class="mobile-form-element">
              ...
              <div class="flex flex-col sm:flex-row mobile-duration gap-2">
                <input :readonly="!entry.isDisplayed" :name="'entries[' + index + '][start_date]'" type="text" class="wes-date mobile-input h-11 w-full border rounded px-3 py-2" x-model="entry.start_date">
                <span class="text-center sm:pt-2 mobile-duration-to text-gray-500">to</span>
                <div class="flex flex-col w-full">
                  <input :class="entry.present ? 'text-gray-400' : ''" :readonly="!entry.isDisplayed || entry.present" :disabled="!entry.isDisplayed || entry.present" :name="'entries[' + index + '][end_date]'" type="text" class="wes-date mobile-input w-full border rounded px-3 py-2" x-model="entry.end_date">
