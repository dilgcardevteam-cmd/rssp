...
<body class="bg-gradient-to-br from-blue-50 via-indigo-50 to-blue-100 text-gray-900 min-h-screen flex flex-col">
    ...
    <div id="documentsModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden modal-transition overflow-y-auto py-4">
        <div class="bg-white rounded-3xl max-w-2xl w-full mx-4 shadow-2xl transform transition-all flex flex-col max-h-[90vh]">
            ...
            <div class="flex-shrink-0 flex items-center justify-end gap-3 p-6 border-t border-gray-200 bg-white rounded-b-3xl">
                ...
                <a href="<?php echo e(route('login.form')); ?>" id="applyNowBtn" class="inline-flex items-center gap-2 bg-[#0D2B70] text-white px-6 py-2 rounded-lg font-bold hover:bg-[#002C76] transition-colors">
        ...
        <div class="relative max-w-7xl mx-auto px-6 py-8">
            ...
            <nav class="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-12 pb-6 border-b border-white/20">
                <div class="flex items-center gap-4">
                    <img src="<?php echo e(asset('images/dilg_logo.png')); ?>" alt="DILG" class="h-16 w-16 rounded-full border-2 border-white/40 bg-white/10">
                ...
                <div class="flex items-center gap-4">
                    <a href="<?php echo e(route('login.form')); ?>" class="text-white/90 hover:text-white font-semibold text-sm transition-colors">Sign In</a>
                    <a href="<?php echo e(route('register.form')); ?>" class="inline-flex items-center gap-2 bg-white text-[#0D2B70] px-6 py-2.5 rounded-full font-bold shadow-lg hover:shadow-xl hover:bg-gray-50 transition-all">
    ...
    <main class="flex-1 bg-gradient-to-b from-blue-50 via-indigo-100 to-blue-50">
        <section class="max-w-7xl mx-auto px-6 py-8">
            <div class="bg-white rounded-2xl shadow-lg p-5 sm:p-6 md:p-8">
                <div class="flex flex-col gap-5 mb-6">
                    <div class="flex items-center justify-between gap-4">
                        ...
                        <span class="hidden sm:inline-flex items-center rounded-full bg-[#0D2B70]/10 px-3 py-1 text-sm font-semibold text-[#0D2B70]">
                            <?php echo e($allCount); ?> Open <?php echo e($allCount === 1 ? 'Vacancy' : 'Vacancies'); ?>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6" id="vacancyGrid">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $vacancies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vacancy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        ...
                        <article
                            ...
                            data-type="<?php echo e($filterType); ?>"
                            data-status="<?php echo e($processStatus); ?>"
                            data-vacancy="<?php echo e(base64_encode(json_encode([
                        ...
                        >
                            <div class="p-5 sm:p-6">
                                <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                                    <div>
                                        <h3 class="font-bold text-[#0D2B70] text-lg sm:text-xl"><?php echo e($vacancy->position_title); ?></h3>
                                        <p class="text-gray-700 text-sm sm:text-base mt-1 font-medium"><?php echo e($vacancy->office_assignment ?? 'DILG - CAR'); ?></p>
                                        <p class="text-[#0D2B70]/75 text-sm mt-1 italic"><?php echo e($vacancyTypeDisplay); ?></p>
                                    </div>
                                    <span class="text-[#0D2B70] font-bold text-base sm:text-lg bg-blue-50 px-4 py-2 rounded-lg w-fit whitespace-nowrap">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($vacancy->salary_grade): ?>
                                            <?php
                                                $gradeNum = preg_replace('/[^0-9]/', '', $vacancy->salary_grade);
                                                if (empty($gradeNum)) $gradeNum = $vacancy->salary_grade;
                                            ?>
                                            SG <?php echo e($gradeNum); ?> - ₱<?php echo e(number_format((float) ($vacancy->monthly_salary ?? 2), 2)); ?>

                                        <?php else: ?>
                                            ₱<?php echo e(number_format((float) ($vacancy->monthly_salary ?? 0), 2)); ?>
                                ...
                                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mt-5 pt-4 border-t border-gray-200">
                                    <div class="space-y-2">
                                        <div class="flex items-center gap-2 text-gray-600 text-sm sm:text-base">
                                            ...
                                            <span><?php echo e($vacancy->place_of_assignment ?? 'DILG-CAR'); ?></span>
                                        </div>
                                        <div class="flex items-center gap-2 text-gray-500 text-sm sm:text-base">
                                            <i data-feather="calendar" class="w-4 h-4"></i>
                                            <span><?php echo e($processStatus === 'CONCLUDED' ? 'Concluded' : 'Deadline'); ?>: <?php echo e(\Carbon\Carbon::parse($vacancy->closing_date)->format('F d, Y')); ?></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3">
                                        ...
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold <?php echo e($badgeClasses); ?>">
                                            <span class="w-2 h-2 <?php echo e($dotColor); ?> rounded-full mr-1.5"></span>
                ...
                <!-- Pagination -->
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($vacancies->hasPages()): ?>
                <div class="mt-12 flex justify-center">
                    <?php echo e($vacancies->links('pagination::tailwind')); ?>
    ...
    <footer class="border-t border-gray-300 bg-blue-50">
        <div class="max-w-7xl mx-auto px-6 py-4 text-sm text-gray-600 flex flex-col sm:flex-row items-center justify-between gap-3">
            <div>© <?php echo e(date('Y')); ?> DILG - CAR</div>
            <div class="flex items-center gap-4">
                <a href="<?php echo e(route('job_vacancy')); ?>" class="text-[#0D2B70] font-semibold hover:underline">Vacancies</a>
                <a href="<?php echo e(route('about')); ?>" class="text-[#0D2B70] font-semibold hover:underline">About</a>
            </div>
        </div>
    </footer>

    <script>
        const documentMetaForLanding = <?php echo json_encode($documentMetaForLanding, 15, 512) ?>;
        const requiredDocsByTrackForLanding = <?php echo json_encode($requiredDocsByTrackForLanding, 15, 512) ?>;
        ...
        document.getElementById('applyNowBtn').addEventListener('click', function(e) {
            ...
            // this.href = "<?php echo e(route('login.form')); ?>?redirect=apply/" + jobId;
        });
...
<?php /**PATH C:\xampp\htdocs\DILG-CAR\resources\views/public/landing.blade.php ENDPATH**/ ?>