<?php $__env->startSection('title', 'Dashboard | DILG-CAR'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="bg-[#f5f7fb]">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
                ...
                <div class="relative z-10 p-6 sm:p-7 lg:p-8 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                    <div class="space-y-3">
                        ...
                        <div class="flex flex-wrap gap-3 pt-1">
                            <a href="<?php echo e(route('job_vacancy')); ?>"
                        ...
                        <div class="relative h-16 w-16 flex items-center justify-center">
                            <svg class="h-16 w-16 -rotate-90" viewBox="0 0 60 60">
                                ...
                                <circle
                                    ...
                                    cx="30"
                                    cy="30"
                                    style="stroke-dasharray: <?php echo e($pdsCircumference); ?>; stroke-dashoffset: <?php echo e($pdsOffset); ?>;"
                                ></circle>
                            </svg>
                            <div class="absolute inset-0 flex items-center justify-center">
                                <span class="text-xs font-extrabold text-[#0D2B70]"><?php echo e($pdsProgressSafe); ?>%</span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-3xl font-extrabold text-[#0D2B70]">
                                    <?php echo e($applications->filter(fn($a) => strtolower(trim((string) ($a->status ?? ''))) === 'pending')->count()); ?>
                    ...
                    <div class="flex items-start justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-3xl font-extrabold text-[#0D2B70]">
                                    <?php echo e(collect($deadlineCountdown)->filter(fn($d) => $d['days_remaining'] <= 5)->count()); ?>
                    ...
                    <div class="flex items-start justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-3xl font-extrabold text-[#0D2B70]"><?php echo e($upcomingExamsCount ?? $upcomingExams->count()); ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="pointer-events-none absolute right-4 top-4 max-w-xs rounded-xl bg-slate-900/90 px-3 py-2 text-[11px] text-slate-50 shadow-lg opacity-0 translate-y-2 transition duration-200 group-hover:opacity-100 group-hover:translate-y-0">
                        ...
                        <div class="flex items-center gap-3">
                            <button type="button" id="action-required-card" class="flex items-center gap-3 text-left">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center gap-2">
                                        <p class="text-3xl font-extrabold text-[#0D2B70]"><?php echo e($actionRequiredCount); ?></p>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($actionRequiredCount > 0): ?>
                    ...
                    <div class="relative w-full max-w-xl rounded-2xl bg-white shadow-2xl border border-slate-100 p-6 space-y-4">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-2 text-[#0D2B70] font-bold">
                                ...
                                <span class="text-xs font-semibold text-orange-600">(<?php echo e($actionRequiredCount); ?>)</span>
                            </div>
                        ...
                        <div class="space-y-3 max-h-[60vh] overflow-y-auto pr-1">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = collect($deadlineCountdown); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deadline): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <?php
                                    $daysRemaining = (int) ($deadline['days_remaining'] ?? 0);
                                ?>
                                <div class="rounded-xl border border-orange-100 bg-orange-50 px-3 py-3">
                                    <p class="text-[11px] font-bold uppercase tracking-wide text-orange-800">Due in <?php echo e($daysRemaining); ?> <?php echo e($daysRemaining === 1 ? 'Day' : 'Days'); ?></p>
                                    <p class="mt-1 text-sm font-bold text-[#0D2B70] leading-snug"><?php echo e($deadline['position_title']); ?></p>
                                    <p class="text-[11px] text-slate-600">Deadline: <?php echo e(\Carbon\Carbon::parse($deadline['deadline'])->format('M d, h:i A')); ?></p>
                                </div>
            ...
            <div class="grid grid-cols-1 xl:grid-cols-12 gap-4">
                ...
                <section class="xl:col-span-7 overflow-hidden rounded-2xl bg-white shadow-lg shadow-slate-200/70 border border-slate-100">
                    <div class="flex items-center justify-between border-b border-slate-100 bg-slate-50/70 px-5 sm:px-6 py-3">
                        ...
                        <a href="<?php echo e(route('my_applications')); ?>" class="text-xs font-bold text-blue-600 hover:text-blue-800 hover:underline">View All</a>
                    </div>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($applications->isEmpty()): ?>
                        <div class="p-8 text-center">
                            ...
                            <div class="mt-4">
                                <a href="<?php echo e(route('job_vacancy')); ?>" class="inline-flex items-center gap-2 rounded-lg bg-[#0D2B70] px-4 py-2 text-sm font-bold text-white shadow-md transition hover:bg-[#0b2560]">
                                        ...
                                        <div class="space-y-1">
                                            <div class="flex items-center gap-2">
                                                <h3 class="text-base font-bold text-[#0D2B70] leading-tight">
                                                    <?php echo e($app->vacancy->position_title ?? 'Unknown Position'); ?>
                                                ...
                                                ?>
                                                <span class="px-2 py-0.5 text-[10px] font-extrabold uppercase tracking-wide rounded-full <?php echo e($statusClass); ?>">
                                                    <?php echo e($app->status); ?>

                                                </span>
                                            </div>
                                            <div class="flex flex-wrap items-center gap-3 text-xs text-slate-500">
                                                <span class="flex items-center gap-1"><i data-feather="map-pin" class="h-3 w-3"></i><?php echo e($app->vacancy->place_of_assignment ?? 'N/A'); ?></span>
                                                <span class="flex items-center gap-1"><i data-feather="calendar" class="h-3 w-3"></i>Applied <?php echo e($app->created_at->format('M d, Y')); ?></span>
                                            </div>
                                        </div>
                                        <div class="flex items-center gap-2">
                                            <a href="<?php echo e(route('application_status', ['user' => Auth::id(), 'vacancy' => $app->vacancy_id])); ?>"
                ...
                <div class="xl:col-span-5 space-y-4">
                    <div class="rounded-2xl bg-white shadow-lg shadow-slate-200/70 border border-slate-100 p-4">
                        <!-- <div class="mb-3 flex items-center justify-between">
                            ...
                            <span class="text-xs font-semibold text-green-600"><?php echo e($pdsProgress); ?>% of documents submitted</span>
                        </div>
                        <div class="mb-4 h-2 w-full rounded-full bg-slate-100">
                            <div class="h-2 rounded-full bg-green-500" style="width: <?php echo e($pdsProgress); ?>%"></div>
                        </div> -->
                        ...
                        ?>
                        <div class="space-y-2">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $pdsLinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <?php
                                    $linkHref = route($link['route']) . (isset($link['fragment']) ? ('#' . $link['fragment']) : '');
                                ?>
                                <a href="<?php echo e($linkHref); ?>" class="flex items-center gap-3 rounded-lg border border-slate-100 px-3 py-2.5 text-sm font-semibold text-slate-700 transition hover:border-blue-200 hover:bg-blue-50">
                                    <span class="flex h-9 w-9 items-center justify-center rounded-full bg-slate-50 text-slate-500">
                                        <i data-feather="<?php echo e($link['icon']); ?>" class="h-4 w-4"></i>
                                    </span>
                                    <span class="flex-1 truncate"><?php echo e($link['name']); ?></span>
                                    <i data-feather="chevron-right" class="h-4 w-4 text-slate-400"></i>
                                </a>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            <a href="<?php echo e(route('display_wes', ['simple' => 1])); ?>" class="flex items-center gap-3 rounded-lg border border-dashed border-blue-200 bg-blue-50/60 px-3 py-2.5 text-sm font-semibold text-blue-700 transition hover:bg-blue-100">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(false && (($requiresApplicantOnboarding ?? false) || $shouldOpenOnboardingModal)): ?>
                <div id="applicant-onboarding-modal" class="hidden fixed inset-0 z-[1300] flex items-start sm:items-center justify-center p-2 sm:p-4 overflow-y-auto">
                    ...
                    <div class="relative w-full max-w-4xl max-h-[calc(100vh-1rem)] sm:max-h-[90vh] rounded-2xl border border-[#0D2B70]/20 bg-white shadow-2xl overflow-hidden flex flex-col"
                        x-data="dashboardOnboardingWizard(
                            <?php echo \Illuminate\Support\Js::from($onboardingVacancyOptions ?? [])->toHtml() ?>,
                            <?php echo \Illuminate\Support\Js::from($onboardingInitialVacancyId)->toHtml() ?>,
                            <?php echo \Illuminate\Support\Js::from($onboardingInitialReadiness)->toHtml() ?>
                        )">
                        ...
                        <form method="POST" action="<?php echo e(route('applicant.onboarding.store')); ?>" class="flex-1 overflow-y-auto p-4 sm:p-6 space-y-4">
                            <?php echo csrf_field(); ?>

                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($onboardingErrorBag->any()): ?>
                                <div class="rounded-xl border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700">
                                    <p class="font-semibold mb-1">Please fix the onboarding details below:</p>
                                    <ul class="list-disc pl-5 space-y-1">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $onboardingErrorBag->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const shouldOpenOnboardingModal = <?php echo json_encode($shouldOpenOnboardingModal, 15, 512) ?>;
...
<?php echo $__env->make('layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\rhrmspb\resources\views/dashboard_user/dashboard_user.blade.php ENDPATH**/ ?>