...
<body class="relative min-h-screen overflow-x-hidden overflow-y-auto bg-[radial-gradient(circle_at_85%_18%,rgba(79,172,254,0.24)_0%,rgba(79,172,254,0)_38%),radial-gradient(circle_at_12%_82%,rgba(15,100,201,0.22)_0%,rgba(15,100,201,0)_34%),linear-gradient(140deg,#031029_0%,#0a255f_46%,#12387e_100%)] p-3 font-['Montserrat'] md:p-6 lg:overflow-hidden">
            ...
            <section class="relative bg-[rgba(249,252,255,0.95)] px-5 py-8 sm:px-8 lg:bg-[linear-gradient(180deg,rgba(255,255,255,0.82)_0%,rgba(248,251,255,0.92)_100%)] lg:px-10">
                <div class="mx-auto w-full max-w-xl">
                    <div class="mb-6 flex items-center gap-3 lg:hidden">
                        <img src="<?php echo e(asset('images/dilg_logo.png')); ?>" alt="DILG Logo" class="h-12 w-12" />
                        <div>
                    ...
                    <div>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($errors->any() && !$registerErrors->any()): ?>
                        ...
                        <form id="adminLoginForm" action="<?php echo e(route('admin.login.submit')); ?>" method="POST" class="space-y-4" autocomplete="off">
                            <?php echo csrf_field(); ?>
    ...
    <div id="adminRegisterModal"
        class="fixed inset-0 z-[12000] <?php echo e($openRegisterModal ? 'flex' : 'hidden'); ?> items-center justify-center bg-[linear-gradient(180deg,rgba(2,10,29,0.74)_0%,rgba(2,10,29,0.66)_100%)] px-4 py-6 backdrop-blur-[3px]">
        <div class="w-full max-w-4xl overflow-hidden rounded-2xl border border-[#d8e3f3] bg-[linear-gradient(180deg,#ffffff_0%,#fbfdff_100%)] shadow-[0_24px_52px_rgba(7,24,58,0.3)]">
            ...
            <div class="max-h-[78vh] overflow-y-auto p-6">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($registerErrors->any()): ?>
                    <div class="mb-4 rounded-xl border border-rose-200 bg-rose-50 px-4 py-3 text-sm text-rose-700">
                        <ul class="list-disc pl-5">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $registerErrors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <li><?php echo e($error); ?></li>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        </ul>
                    </div>
                ...
                <form id="adminRegisterForm" action="<?php echo e(route('admin.register.submit')); ?>" method="POST" class="space-y-4" autocomplete="off">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="md:col-span-2 rounded-xl border border-slate-200 bg-slate-50 p-3">
                            ...
                            <div class="grid gap-3 md:grid-cols-2">
                                <div>
                                    ...
                                    <input type="text" name="office" value="<?php echo e(old('office')); ?>" required placeholder="Enter office/unit"
                                        class="w-full rounded-[0.85rem] border border-[#cdd9eb] bg-[#fbfdff] px-3 py-2.5 text-sm text-[#203457] outline-none transition-[border-color,box-shadow,background-color] hover:border-[#b5c8e7] hover:bg-white focus:border-[#0d2b70] focus:bg-white focus:ring-4 focus:ring-[#0d2b70]/15">
                                </div>
                                <div>
                                    <label class="mb-1.5 block text-[0.68rem] font-bold uppercase tracking-[0.12em] text-[#52627d]">Designation</label>
                                    <input type="text" name="designation" value="<?php echo e(old('designation')); ?>" required placeholder="Enter position/designation"
                                        class="w-full rounded-[0.85rem] border border-[#cdd9eb] bg-[#fbfdff] px-3 py-2.5 text-sm text-[#203457] outline-none transition-[border-color,box-shadow,background-color] hover:border-[#b5c8e7] hover:bg-white focus:border-[#0d2b70] focus:bg-white focus:ring-4 focus:ring-[#0d2b70]/15">
                                </div>
                            </div>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const shouldOpenRegisterModal = <?php echo json_encode($openRegisterModal, 15, 512) ?>;
...
<?php /**PATH C:\xampp\htdocs\DILG-CAR\resources\views/login_register/admin_login.blade.php ENDPATH**/ ?>