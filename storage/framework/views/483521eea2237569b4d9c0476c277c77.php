  ...
  <style>
    ...
    <body>
        ...
        <div class="container">
            <!-- Header -->
            <div class="header">
            <img class="logo" src="<?php echo e($logoSrc); ?>" alt="DILG Logo" style="object-fit:contain;">
            ...
            <!-- Content -->
            <div class="content">
            <p>Hello <?php echo e($user->name ?? 'Applicant'); ?>!</p>
            <p>
            ...
            <h3><?php echo e($vacancy->position_title ?? '[Position Title]'); ?></h3>
            ...
            <a href="<?php echo e($join_link ?? '#'); ?>" class="join-button">Access Exam Link</a>
            ...
            <p class="note" style="margin-top:10px;">
              Important: The link is single-use per device and remains valid until <?php echo e($expiryLabel ?? 'the end of the scheduled exam window'); ?>.
            </p>

            <p class="note">
                If the button above does not work, please copy and paste this link into your browser:<br>
                <p class="note" style="word-break: break-all; margin-top: -10px;"><?php echo e($join_link ?? '[exam_link_here]'); ?> </p>
            </p>
            ...
            <p>
                <strong>Sent by:</strong> <?php echo e($senderName ?? 'DILG-CAR Recruitment Team'); ?>
...
<?php /**PATH C:\xampp\htdocs\DILG-CAR\resources\views/emails/exam_sched_link.blade.php ENDPATH**/ ?>