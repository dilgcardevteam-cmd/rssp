            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $applications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $application): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                <div class="flex flex-col lg:flex-row lg:items-center text-[#0D2B70] hover:bg-blue-50 transition-colors duration-200 p-5 lg:p-0">
                    ...
                    <div class="lg:py-4 lg:px-6 lg:w-[20%] mb-2 lg:mb-0 flex items-center lg:block">
                        ...
                        <span class="font-semibold"><?php echo e($application->vacancy_id ?? $application->vacancy->vacancy_id ?? 'N/A'); ?></span>
                    </div>
                    ...
                    <div class="lg:py-4 lg:px-6 lg:w-[30%] mb-2 lg:mb-0">
                        ...
                        ?>
                        <p class="font-bold lg:font-medium"><?php echo e($application->vacancy->position_title ?? 'Position Title Unavailable'); ?></p>
                        <p class="text-[#0D2B70]/70 text-sm lg:text-[0.9rem] italic"><?php echo e($vacTypeLabel); ?></p>
                    </div>
                    ...
                    <div class="lg:py-4 lg:px-6 lg:w-[25%] mb-2 lg:mb-0 flex items-center lg:block">
                        ...
                        <span class="text-sm lg:text-base"><?php echo e($application->vacancy->place_of_assignment ?? 'N/A'); ?></span>
                    </div>
                    ...
                    <div class="lg:py-4 lg:px-6 lg:w-[10%] mb-4 lg:mb-0 flex items-center lg:justify-center">
                        ...
                        ?>
                        <span class="px-3 py-1 rounded-full text-xs font-semibold <?php echo e($badge); ?>">
                    ...
                    <div class="lg:py-4 lg:px-6 lg:w-[15%] flex lg:justify-center gap-2">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isNotQualified): ?>
                            <button
                                type="button"
                                disabled
                        ...
                        <?php else: ?>
                            <button
                                onclick="window.location.href='<?php echo e(route('application_status', [$application->user_id, $application->vacancy_id])); ?>'"
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($displayStatusNormalized === 'pending'): ?>
                            <form id="cancel-application-form-<?php echo e($application->vacancy_id); ?>" method="POST" action="<?php echo e(route('application_status.cancel', ['user' => $application->user_id, 'vacancy' => $application->vacancy_id])); ?>">
                                <?php echo csrf_field(); ?>
                                <button type="button" onclick="if(confirm('Cancel this application? This action cannot be undone.')) document.getElementById('cancel-application-form-<?php echo e($application->vacancy_id); ?>').submit();" class="w-full lg:w-auto justify-center text-red-600 border border-red-500 font-bold py-2.5 lg:py-1 px-4 rounded-md text-sm transition-all duration-300 hover:scale-105 hover:bg-red-500 hover:text-white hover:shadow-md inline-flex items-center gap-2">
...
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php /**PATH C:\xampp\htdocs\rhrmspb\resources\views/partials/application_list_container.blade.php ENDPATH**/ ?>