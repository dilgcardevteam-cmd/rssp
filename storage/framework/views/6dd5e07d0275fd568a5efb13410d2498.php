...
<head>
    ...
    <?php echo $__env->make('partials.global_toast', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<body class="bg-[#F1F6FC] h-screen font-sans font-montserrat text-gray-900 overflow-hidden">
    ...
    <div id="app-wrapper" class="flex h-screen w-full overflow-hidden">
        ...
        <div class="lg:hidden">
            <?php echo $__env->make('partials.mobile-sidebar-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>

        <div class="hidden lg:block">
            <?php echo $__env->make('partials.sidebar_admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
        ...
        <div class="flex-1 flex flex-col h-screen overflow-hidden relative min-w-0">
                ...
                <div class="flex items-center gap-1 rounded-full border border-slate-200 bg-white/80 backdrop-blur-sm px-2 py-1 shadow-sm">
                    ...
                    <div id="notifBell" class="relative">
                        ...
                        <div id="notifMenu"
                            ...
                            <div class="px-4 py-3 bg-white border-t border-slate-100 text-center">
                                <a href="<?php echo e(route('admin.notifications.index', [], false)); ?>"
                    ...
                    <div class="relative" x-data="{ open: false }">
                        <button @click="open = !open"
                            ...
                            <div class="text-right hidden sm:block">
                                <p class="text-sm font-semibold text-slate-800 leading-tight">
                                    <?php echo e(Auth::guard('admin')->user()->name ?? 'Admin User'); ?>

                                </p>
                                <p class="text-[11px] text-slate-500 uppercase tracking-wide">
                                    <?php echo e(match (Auth::guard('admin')->user()->role ?? 'admin') {
                        ...
                        <div x-show="open" @click.away="open = false"
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array((Auth::guard('admin')->user()->role ?? null), ['superadmin', 'admin'], true)): ?>
                            ...
                            <form id="adminLogoutForm" method="POST" action="<?php echo e(route('admin.logout')); ?>">
                                <?php echo csrf_field(); ?>
            ...
            <main id="page-shell"
                class="page-enter flex-1 <?php echo e($lockScreenScroll ? 'overflow-hidden pb-0' : 'overflow-y-auto overflow-x-hidden pb-6 sm:pb-8 md:pb-10'); ?> <?php echo $__env->yieldContent('main-padding', 'px-6 sm:px-8 md:px-10'); ?> pt-0 relative scroll-smooth">
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Confirm Logout','message' => 'Are you sure you want to log out?','event' => 'open-logout-confirm','confirm' => 'confirm-logout']); ?>
...
document.addEventListener('DOMContentLoaded', () => {
        ...
        <?php if(session('applicant_deletion_daily_notice')): ?>
            if (typeof window.showAppToast === 'function') {
                window.showAppToast(<?php echo json_encode(session('applicant_deletion_daily_notice'), 15, 512) ?>, 'success', 7000);
            }
        <?php endif; ?>
...
<?php echo $__env->make('partials.idle_logout', [
...
<?php /**PATH C:\xampp\htdocs\DILG-CAR\resources\views/layout/admin.blade.php ENDPATH**/ ?>