...
<div id="chat-window"
    ...
    <div class="relative">
        <img src="<?php echo e(asset('images/dilg-chatbot.png')); ?>"
             alt="AI Avatar"
    ...
    <div class="flex items-center gap-2">
        <div class="w-6 h-6 rounded-full flex items-center justify-center text-xs overflow-hidden bg-white">
            <img src="<?php echo e(asset('images/dilg-chatbot.png')); ?>" alt="Chatbot" class="w-full h-full object-cover" />
        </div>
...
</script><?php /**PATH C:\xampp\htdocs\rhrmspb\resources\views/partials/chat_ai.blade.php ENDPATH**/ ?>