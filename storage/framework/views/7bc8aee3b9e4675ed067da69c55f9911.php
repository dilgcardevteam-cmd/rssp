    ...
    ?>
    <aside id="sidebar"
        class="sidebar sidebar-transition fixed top-5 left-5 flex flex-col justify-between bg-white text-[#002C76] rounded-xl shadow-lg <?php echo e($simple ? 'overflow-y-hidden w-72' : 'overflow-hidden w-16'); ?> z-[60] h-[95vh]">
        ...
        <div>
            <a class="flex items-center gap-2 pt-14 px-2">
                ...
                <div id="sidebarText" class="<?php echo e($simple ? 'sidebar-text-visible' : 'sidebar-text-hidden'); ?> whitespace-nowrap overflow-hidden">
            ...
            <nav class="mt-8 space-y-1 px-2 font-montserrat" aria-label="Main navigation">
                <a href="<?php echo e(route('dashboard_user')); ?>"
                    class="group flex items-center rounded-md px-4 py-2 text-sm font-bold transition use-loader
                        <?php echo e(request()->routeIs('dashboard_user')
                ...
                <a href="<?php echo e(route('job_vacancy')); ?>"
                    class="group flex items-center rounded-md px-4 py-2 text-sm font-bold transition use-loader
                        <?php echo e(request()->routeIs('job_vacancy')
                            ? 'bg-[#002C76] text-white'
                            : 'text-[#002C76] hover:text-white hover:bg-[#002C76]'); ?>">
                ...
                <a href="<?php echo e(route('my_applications')); ?>"
                    class="group flex items-center rounded-md px-4 py-2 text-sm font-bold transition use-loader
                        <?php echo e(request()->routeIs('my_applications')
                            ? 'bg-[#002C76] text-white'
                            : 'text-[#002C76] hover:text-white hover:bg-[#002C76]'); ?>">
                ...
                <div class="w-full">
                    <div class="flex items-center justify-between w-full rounded-md px-4 py-2 text-sm font-bold transition
                        <?php echo e((request()->routeIs('display_c1') || request()->routeIs('display_c2') || request()->routeIs('display_c3') || request()->routeIs('display_c4') || request()->routeIs('display_wes') || request()->routeIs('display_c5'))
                            ? 'bg-[#002C76] text-white'
                            : 'text-[#002C76] hover:text-white hover:bg-[#002C76]'); ?>">
                        <a href="<?php echo e(route('display_c1', ['simple' => 1])); ?>" class="flex items-center use-loader">
                        ...
                        <button type="button" id="pdsToggle" aria-expanded="<?php echo e((request()->routeIs('display_c1') || request()->routeIs('display_c2') || request()->routeIs('display_c3') || request()->routeIs('display_c4') || request()->routeIs('display_wes') || request()->routeIs('display_c5')) ? 'true' : 'false'); ?>" class="ml-2">
                            <i id="pdsCaret" data-feather="chevron-down" class="w-4 h-4 stroke-[3]"></i>
                        </button>
                    </div>
                    <div id="pdsMenu" class="pds-menu <?php echo e((request()->routeIs('display_c1') || request()->routeIs('display_c2') || request()->routeIs('display_c3') || request()->routeIs('display_c4') || request()->routeIs('display_wes') || request()->routeIs('display_c5')) ? 'show' : ''); ?> mt-1 pl-10 space-y-1">
                        <a href="<?php echo e(route('display_c1', ['simple' => 1])); ?>"
                            class="flex items-center rounded-md px-3 py-2 text-sm font-semibold transition use-loader
                                <?php echo e(request()->routeIs('display_c1')
                                    ? 'bg-[#002C76] text-white'
                                    : 'text-[#002C76] hover:text-white hover:bg-[#002C76]'); ?>">
                            <i data-feather="user" class="w-4 h-4 stroke-[3] flex-shrink-0"></i>
                            <span class="ml-3">PERSONAL INFORMATION</span>
                        </a>
                        <a href="<?php echo e(route('display_c2', ['simple' => 1])); ?>"
                            class="flex items-center rounded-md px-3 py-2 text-sm font-semibold transition use-loader
                                <?php echo e(request()->routeIs('display_c2')
                                    ? 'bg-[#002C76] text-white'
                                    : 'text-[#002C76] hover:text-white hover:bg-[#002C76]'); ?>">
                            <i data-feather="briefcase" class="w-4 h-4 stroke-[3] flex-shrink-0"></i>
                            <span class="ml-3">WORK EXPERIENCE</span>
                        </a>
                        <a href="<?php echo e(route('display_c3', ['simple' => 1])); ?>"
                            class="flex items-center rounded-md px-3 py-2 text-sm font-semibold transition use-loader
                                <?php echo e(request()->routeIs('display_c3')
                                    ? 'bg-[#002C76] text-white'
                                    : 'text-[#002C76] hover:text-white hover:bg-[#002C76]'); ?>">
                            <i data-feather="book-open" class="w-4 h-4 stroke-[3] flex-shrink-0"></i>
                            <span class="ml-3">LEARNING &amp; DEVELOPMENT</span>
                        </a>
                        <a href="<?php echo e(route('display_c4', ['simple' => 1])); ?>"
                            class="flex items-center rounded-md px-3 py-2 text-sm font-semibold transition use-loader
                                <?php echo e(request()->routeIs('display_c4')
                                    ? 'bg-[#002C76] text-white'
                                    : 'text-[#002C76] hover:text-white hover:bg-[#002C76]'); ?>">
                            <i data-feather="info" class="w-4 h-4 stroke-[3] flex-shrink-0"></i>
                            <span class="ml-3">OTHER INFORMATION</span>
                        </a>
                        <a href="<?php echo e(route('display_wes', ['simple' => 1])); ?>"
                            class="flex items-center rounded-md px-3 py-2 text-sm font-semibold transition use-loader
                                <?php echo e(request()->routeIs('display_wes')
                                    ? 'bg-[#002C76] text-white'
                                    : 'text-[#002C76] hover:text-white hover:bg-[#002C76]'); ?>">
                            <i data-feather="briefcase" class="w-4 h-4 stroke-[3] flex-shrink-0"></i>
                ...
                <div class="w-full">
                    ...
                    <div id="docsMenu" class="pds-menu mt-1 pl-10 space-y-1">
                        <a href="<?php echo e(route('pds.preview')); ?>" target="_blank" rel="noopener"
                        ...
                        <a href="<?php echo e(route('wes.preview')); ?>" target="_blank" rel="noopener"
                            class="flex items-center rounded-md px-3 py-2 text-sm font-semibold transition text-[#002C76] hover:text-white hover:bg-[#002C76]">
                ...
                <a href="<?php echo e(route('manual.user')); ?>"
                    class="group flex items-center rounded-md px-4 py-2 text-sm font-bold transition use-loader
                        <?php echo e(request()->routeIs('manual.user')
                            ? 'bg-[#002C76] text-white'
                            : 'text-[#002C76] hover:text-white hover:bg-[#002C76]'); ?>">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const isSimple = <?php echo e($simple ? 'true' : 'false'); ?>;
...
<?php /**PATH C:\xampp\htdocs\rhrmspb\resources\views/partials/sidebar.blade.php ENDPATH**/ ?>