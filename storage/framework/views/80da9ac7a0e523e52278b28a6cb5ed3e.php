...
<?php $__env->startSection('content'); ?>
    ...
    <div class="px-4 pb-8 sm:px-8">
                ...
                <div class="grid grid-cols-1 gap-3 xl:grid-cols-[minmax(0,1.5fr)_repeat(4,minmax(0,1fr))]">
                    <div>
                        ...
                        <div class="relative">
                            <input
                                ...
                                type="search"
                                value="<?php echo e($selectedSearch); ?>"
                    ...
                    <div>
                        ...
                        <select id="myApplicationsTypeFilter" class="w-full rounded-lg border border-[#0D2B70]/20 bg-white px-3 py-2 text-sm text-[#0D2B70] focus:outline-none focus:ring-2 focus:ring-[#0D2B70]/35">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ($filterOptions['vacancyTypes'] ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vacancyType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <option value="<?php echo e($vacancyType); ?>" <?php if(strtolower($selectedVacancyType) === strtolower($vacancyType)): echo 'selected'; endif; ?>><?php echo e($vacancyType); ?></option>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <select id="myApplicationsStatusFilter" class="w-full rounded-lg border border-[#0D2B70]/20 bg-white px-3 py-2 text-sm text-[#0D2B70] focus:outline-none focus:ring-2 focus:ring-[#0D2B70]/35">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ($filterOptions['statuses'] ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $statusOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <option value="<?php echo e($statusOption); ?>" <?php if(strtolower($selectedStatus) === strtolower($statusOption)): echo 'selected'; endif; ?>><?php echo e($statusOption); ?></option>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <select id="sortMyApplications" class="w-full rounded-lg border border-[#0D2B70]/20 bg-white px-3 py-2 text-sm text-[#0D2B70] focus:outline-none focus:ring-2 focus:ring-[#0D2B70]/35">
                            <option value="latest" <?php if($selectedSortOrder === 'latest'): echo 'selected'; endif; ?>>Latest</option>
                            <option value="oldest" <?php if($selectedSortOrder === 'oldest'): echo 'selected'; endif; ?>>Oldest</option>
                        </select>
                    </div>
                </div>
        ...
        <div id="applicationListContainer" class="space-y-6 application-list-mobile">
            <?php echo $__env->make('partials.application_list_container', ['applications' => $applications, 'hasActiveFilters' => $hasActiveFilters], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
...
(() => {
    ...
    const syncUrl = () => {
        ...
        const nextUrl = queryString ? `<?php echo e(route('my_applications')); ?>?${queryString}` : `<?php echo e(route('my_applications')); ?>`;
    ...
    const fetchApplications = async (options = {}) => {
        ...
        try {
            ...
            const requestUrl = params.toString()
                ? `<?php echo e(route('my_applications.sort')); ?>?${params.toString()}`
                : `<?php echo e(route('my_applications.sort')); ?>`;
...
<?php echo $__env->make('layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\rhrmspb\resources\views/dashboard_user/my_applications.blade.php ENDPATH**/ ?>