<?php $__env->startSection('title', 'DILG - Dashboard Admin'); ?>
    ...
    <div class="flex flex-col h-full gap-3 md:gap-4 overflow-y-auto scrollbar-thin">
        ...
        <section class="text-center sm:text-left">
            ...
            <h1 class="font-extrabold text-2xl sm:text-3xl tracking-tight font-montserrat text-[#002C76]">
                <?php echo e(auth('admin')->user()->name ?? 'Admin'); ?>
                    ...
                    <div class="flex flex-col justify-center h-full space-y-1">
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="flex flex-col items-start">
                                <span
                                    class="font-extrabold text-2xl sm:text-3xl md:text-4xl text-[#002C76] font-montserrat"><?php echo e($openVacancyCount); ?></span>
                                <span
                            ...
                            <div class="flex flex-col justify-center gap-1">
                                <div class="text-xs sm:text-sm text-gray-800 font-montserrat">
                                    <span class="font-bold"><?php echo e($cosVacancyCount); ?></span> <span
                                        class="hidden sm:inline">Contract of Service</span><span
                                        class="sm:hidden">COS</span>
                                </div>
                                <div class="text-xs sm:text-sm text-gray-800 font-montserrat">
                                    <span class="font-bold"><?php echo e($plantillaVacancyCount); ?></span> Plantilla
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex justify-between items-start z-10 relative h-full">
                    <div class="flex flex-col justify-center h-full space-y-1">
                        <span class="text-[9px] sm:text-[10px] font-bold text-gray-500 uppercase tracking-wider">Reviewed
                            Applications</span>
                        <span
                            class="font-extrabold text-2xl sm:text-3xl md:text-4xl text-[#002C76] font-montserrat"><?php echo e($reviewedApplicationsCount); ?></span>
                    </div>
                    <div
                        class="w-10 h-10 flex items-center justify-center rounded-full bg-blue-50 group-hover:bg-[#002C76] transition-colors duration-300">
                ...
                <div class="flex justify-between items-start z-10 relative h-full">
                    <div class="flex flex-col justify-center h-full space-y-1">
                        <span class="text-[9px] sm:text-[10px] font-bold text-gray-500 uppercase tracking-wider">Upcoming
                            Exams</span>
                        <span
                            class="font-extrabold text-2xl sm:text-3xl md:text-4xl text-[#002C76] font-montserrat"><?php echo e($upcomingExamsCount); ?></span>
                    </div>
                    <div
                        class="w-10 h-10 flex items-center justify-center rounded-full bg-blue-50 group-hover:bg-[#002C76] transition-colors duration-300">
                        <svg class="w-5 h-5 text-[#002C76] group-hover:text-white transition-colors duration-300"
                ...
                <div class="flex justify-between items-start z-10 relative h-full">
                    <div class="flex flex-col justify-center h-full space-y-1">
                        <span class="text-[9px] sm:text-[10px] font-bold text-gray-500 uppercase tracking-wider">System
                            Users</span>
                        <span
                            class="font-extrabold text-2xl sm:text-3xl md:text-4xl text-[#002C76] font-montserrat"><?php echo e($systemUsersCount); ?></span>
                    </div>
                    <div
                        class="w-10 h-10 flex items-center justify-center rounded-full bg-blue-50 group-hover:bg-[#002C76] transition-colors duration-300">
                        <svg class="w-5 h-5 text-[#002C76] group-hover:text-white transition-colors duration-300"
                ...
                <div
                    ...
                    <div id="noDataMessage" class="hidden flex-1 flex items-center justify-center">
                        <p class="text-gray-500 text-sm">No application data available for
                            <?php echo e($selectedYear ?? now()->year); ?>
    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                ...
                if (ctxPie) {
                    const reviewedCount = <?php echo e($reviewedApplicationsCount ?? 0); ?>;
                    const ongoingCount = <?php echo e($onGoingApplicationsCount ?? 0); ?>;
                ...
                if (ctxBar) {
                    const cosCount = <?php echo e($cosVacancyCount ?? 0); ?>;
                    const plantillaCount = <?php echo e($plantillaVacancyCount ?? 0); ?>;
...
<?php echo $__env->make('layout.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\DILG-CAR\resources\views/admin/dashboard_admin.blade.php ENDPATH**/ ?>