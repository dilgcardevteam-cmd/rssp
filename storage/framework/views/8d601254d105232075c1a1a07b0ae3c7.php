...
<?php $__env->startSection('title', 'DILG - Manage Exam'); ?>
...
<main class="w-full h-full flex flex-col overflow-hidden px-4 lg:px-0">
    ...
    <section class="flex-none flex flex-col lg:flex-row items-start lg:items-center justify-between gap-3 max-w-full border-b border-[#0D2B70] pb-2">
        <div class="flex items-center gap-4">
            <button aria-label="Back" onclick="window.location.href='<?php echo e(route('admin_exam_management')); ?>'" class="use-loader group">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($statusMessage): ?>
            <div class="px-4 py-1 border-l-4 rounded shadow-sm flex items-center gap-3 <?php echo e($statusClass); ?> lg:mr-4 w-full lg:w-auto">
                <div class="flex items-center gap-2">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isExamActive): ?>
                        <span class="relative flex h-2 w-2">
                          <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-yellow-400 opacity-75"></span>
                          <span class="relative inline-flex rounded-full h-2 w-2 bg-yellow-500"></span>
                        </span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <span class="font-bold uppercase text-xs tracking-wide"><?php echo e($statusMessage); ?></span>
                </div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isExamActive || $isExamCompleted): ?>
    ...
    <section class="flex-none rounded-xl">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-2 mb-2">
            ...
            <div class="text-sm text-[#002C76] font-montserrat">
                <span class="text-xl md:text-2xl lg:text-3xl font-semibold">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($questionsCount > 0): ?>
                        <span class="text-xl md:text-2xl lg:text-3xl font-normal">
                            <?php echo e($questionsCount); ?>-question examination
                        </span>
                    <?php else: ?>
                ...
                <p class="text-xs md:text-sm"><span class="font-bold">VACANCY ID:</span> <?php echo e($vacancy->vacancy_id); ?>, <?php echo e($vacancy->vacancy_type); ?> Position | <span class="font-bold">BATCH <?php echo e($activeBatch); ?></span></p>
                <!-- <div class="mt-1">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($questionsCount > 0): ?>
            ...
            <div class="flex items-center gap-2">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($batchNoBtn = 1; $batchNoBtn <= 3; $batchNoBtn++): ?>
                    <a href="<?php echo e(route('admin.manage_exam', ['vacancy_id' => $vacancy->vacancy_id, 'batch' => $batchNoBtn])); ?>"
                       class="px-3 py-1 rounded-md border text-sm font-semibold <?php echo e($activeBatch === $batchNoBtn ? 'bg-[#0D2B70] text-white border-[#0D2B70]' : 'bg-white text-[#0D2B70] border-[#0D2B70]'); ?>">
                        <?php echo e($batchNoBtn); ?>
        ...
        <div class="w-full lg:w-[70%] flex flex-col overflow-hidden border-r border-gray-200 pr-4">
            ...
            <div class="flex-none flex gap-6 border-b border-gray-200 mb-4">
                <button id="tab-questions" onclick="switchTab('exam-questions')"
                    ...
                    Exam Questions
                    <!-- <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($qualifiedApplicants->count() > 0): ?>
                        <span class="ml-2 bg-[#0D2B70] text-white text-[10px] font-bold px-1.5 py-0.5 rounded-full align-middle">
                            <?php echo e($qualifiedApplicants->count()); ?>

                        </span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?> -->
                </button>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showQualifiedWorkflow): ?>
                ...
                <button id="tab-attendance" onclick="switchTab('attendance')"
                    class="tab-button pb-2 font-bold text-gray-400 border-b-2 border-transparent hover:text-[#0D2B70] transition-all duration-200 text-sm uppercase tracking-wide">
                    Attendance
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($attendanceCount > 0): ?>
                        <span id="attendanceCountBadge" class="ml-2 bg-[#0D2B70] text-white text-[10px] font-bold px-1.5 py-0.5 rounded-full align-middle">
                            <?php echo e($attendanceCount); ?>
            ...
            <div id="content-exam-questions" class="tab-content flex-1 flex flex-col min-h-0 overflow-hidden">
                <div class="flex flex-col gap-4 overflow-y-auto pr-2">
                    ...
                    ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($examQuestions->count() > 0): ?>
                        <ol class="list-decimal pl-6 space-y-4">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $examQuestions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $q): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <li class="bg-slate-50 rounded-xl p-4 border border-slate-200">
                                    <div class="font-semibold text-[#0D2B70] mb-2"><?php echo nl2br(e($q->question)); ?></div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($q->is_essay ?? false) || ($q->type ?? '') === 'essay'): ?>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <ul class="list-disc pl-6 space-y-1">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $questionChoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $choice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                                <li class="mb-1"><?php echo nl2br(e($choice)); ?></li>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                        </ul>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($q->ans)): ?>
                                            <div class="mt-2 text-xs text-green-700">Correct Answer: <span class="font-bold"><?php echo nl2br(e($q->ans)); ?></span></div>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <div class="mt-2 text-xs text-gray-400">Question #<?php echo e($loop->iteration); ?></div>
                                </li>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        </ol>
                    <?php else: ?>
                            ...
                            <div class="max-w-md">
                                ...
                                <!-- <div class="mt-6 flex flex-col sm:flex-row items-center justify-center gap-3">
                                    <button type="button" onclick="handleEditClick(event)"
                                        <?php echo e((($isExamActive && $isExamDay) || $isExamCompleted) ? 'disabled' : ''); ?>
                            ...
                            <tbody id="qualified-applicants-list" class="divide-y divide-[#0D2B70]">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $qualifiedApplicants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $applicant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <tr class="text-[#0D2B70] select-none hover:bg-blue-50 transition-colors duration-200">
                                        <td class="py-2.5 px-6 font-semibold"><?php echo e($applicant['name']); ?></td>
                                        <!-- <td class="py-2.5 px-6"><?php echo e($applicant['email']); ?></td> -->
                                        <td class="py-2.5 px-6 max-w-[200px] truncate"> <?php echo e($applicant['email']); ?></td>
                                        <td class="py-2.5 px-6"><?php echo e($applicant['application_date']); ?></td>
                                        <td class="py-2.5 px-6 text-center">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($applicant['has_attendance_response']): ?>
                                                <span class="px-3 py-1 rounded-full text-xs font-semibold bg-green-100 text-green-800 flex items-center justify-center gap-1"
                                                    title="Confirmed: <?php echo e($applicant['attendance_responded_at'] ?: 'N/A'); ?>">
                                                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                                                    Confirmed
                                                </span>
                                            <?php elseif($applicant['attendance_prompt_sent']): ?>
                                                <span class="px-3 py-1 rounded-full text-xs font-semibold bg-blue-100 text-blue-800 flex items-center justify-center gap-1"
                                                    title="Sent: <?php echo e($applicant['attendance_prompt_sent_at'] ? \Carbon\Carbon::parse($applicant['attendance_prompt_sent_at'])->format('M d, Y h:i A') : 'N/A'); ?>">
                                        ...
                                        <td class="py-2.5 px-6 text-center">
                                            <a
                                                href="<?php echo e(route('admin.applicant_status', ['user_id' => $applicant['user_id'], 'vacancy_id' => $applicant['vacancy_id']])); ?>"
                                                target="_blank"
            ...
            <div id="content-attendance" class="tab-content hidden flex-1 flex flex-col min-h-0 overflow-hidden">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$showQualifiedWorkflow): ?>
                    <div class="mb-3 rounded-xl border border-blue-200 bg-blue-50 px-4 py-3 text-sm text-[#0D2B70]">
                        <p><span class="font-bold">Batch <?php echo e($activeBatch); ?> Schedule:</span> <?php echo e($examDetails->date ?? 'Not set'); ?> <?php echo e($examDetails->time ?? ''); ?></p>
                        <p class="mt-1"><span class="font-bold">Message:</span> <?php echo e($examDetails->message ?? 'No message yet.'); ?></p>
                    ...
                    <div class="flex-1 overflow-auto">
                        <table class="w-full table-fixed border-collapse text-left">
                            ...
                            <tbody id="attendance-applicants-list" class="divide-y divide-[#0D2B70]">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $attendanceApplicants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $applicant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <tr id="attendance-row-<?php echo e($applicant['user_id']); ?>" class="group text-[#0D2B70] hover:bg-blue-50 transition-colors duration-200">
                                        <td class="w-[24%] py-2.5 px-6 font-semibold whitespace-nowrap overflow-hidden text-ellipsis"><?php echo e($applicant['name']); ?></td>
                                        <td class="w-[18%] py-2.5 px-6 text-center">
                                            <span class="attendance-status-badge inline-flex whitespace-nowrap px-3 py-1 rounded-full text-xs font-semibold <?php echo e($applicant['attendance_badge_class']); ?>">
                                                <?php echo e($applicant['attendance_label']); ?>

                                            </span>
                                        </td>
                                        <td class="w-[20%] py-2.5 px-6 text-center text-sm text-slate-600 whitespace-nowrap">
                                            <?php echo e($applicant['attendance_responded_at'] ?: '-'); ?>
                                        ...
                                        <td class="w-[24%] py-2.5 px-6 text-sm text-slate-600">
                                            ...
                                            <button
                                                type="button"
                                                class="attendance-remark-trigger inline-flex max-w-full items-center rounded-full border px-3 py-1 text-xs font-medium <?php echo e($hasAttendanceRemark ? 'border-slate-200 bg-slate-50 text-slate-700 shadow-sm hover:border-[#0D2B70]/30 hover:bg-white' : 'border-slate-200 bg-slate-100 text-slate-500 italic'); ?>"
                                                data-tooltip-title="Attendance Remark"
                                                data-tooltip-content="<?php echo e($attendanceRemark); ?>"
                                                aria-label="View full attendance remark"
                                            >
                                                <span class="block max-w-full truncate whitespace-nowrap"><?php echo e($attendanceRemark); ?></span>
                                            </button>
                                        </td>
                                        <td class="w-[14%] py-2.5 px-6">
                                            <div class="flex items-center justify-center gap-2">
                                                ...
                                                ?>
                                                <button type="button"
                                                    onclick="overrideAttendanceStatus(<?php echo e($applicant['user_id']); ?>, 'will_attend')"
                                                    title="<?php echo e($isWillAttend ? 'Already marked as Will Attend' : 'Mark as Will Attend'); ?>"
                                                    aria-label="Mark as Will Attend"
                                                    <?php echo e($isWillAttend ? 'disabled' : ''); ?>
                                                ...
                                                <button type="button"
                                                    onclick="overrideAttendanceStatus(<?php echo e($applicant['user_id']); ?>, 'will_not_attend', <?php echo \Illuminate\Support\Js::from($applicant['attendance_remark'])->toHtml() ?>)"
                                                    title="<?php echo e($isWillNotAttend ? 'Already marked as Will Not Attend' : 'Mark as Will Not Attend'); ?>"
                                                    aria-label="Mark as Will Not Attend"
                                                    <?php echo e($isWillNotAttend ? 'disabled' : ''); ?>
            ...
            <div id="content-lobby" class="tab-content hidden flex-1 flex flex-col min-h-0 overflow-hidden border border-[#0D2B70] rounded-xl">
                ...
                <div class="flex-1 overflow-y-auto bg-white">
                    <div class="flex items-center justify-between p-2 bg-gray-50 border-b border-[#0D2B70]">
                        ...
                        <div class="flex items-center gap-2">
                            <button id="pauseExamBtn" onclick="toggleExamPause()" <?php if(!($isExamActive ?? false)): ?> disabled <?php endif; ?>
                                title="<?php if($isExamActive): ?> Pause exam <?php else: ?> Exam not started <?php endif; ?>"
                                class="text-xs bg-amber-500 border border-amber-600 text-white hover:bg-amber-600 px-3 py-1 rounded transition-colors duration-200 flex items-center gap-1 <?php if(!($isExamActive ?? false)): ?> opacity-50 cursor-not-allowed <?php endif; ?>">
                                <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                    ...
                    <table class="w-full text-left border-collapse">
                        <tbody id="exam-lobby-tbody" class="bg-white divide-y divide-gray-200">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($participants) > 0): ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $participants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <tr class="hover:bg-blue-50 transition-colors duration-200">
                                    <!-- Name -->
                                    <td class="py-2.5 px-3 md:py-3 md:px-6 text-[#0D2B70] font-semibold text-xs md:text-sm w-[25%] md:w-[25%]">
                                        <?php echo e($user_name[$index] ?? 'Unknown User'); ?>

                                                                            <div class="mt-1 text-[10px] md:text-xs text-gray-600 font-medium">
                                        <span class="whitespace-nowrap">Switches: <?php echo e((int) ($p->tab_switch_count ?? $p->tab_violations ?? 0)); ?></span>
                                        <span class="mx-1 text-gray-400">|</span>
                                        <span class="whitespace-nowrap">Tamper: <?php echo e((int) ($p->tamper_logs_count ?? 0)); ?></span>
                                    </div>
                                    </td>
                                    ...
                                    <td class="py-2.5 px-3 md:py-3 md:px-6 text-center text-[#0D2B70] font-medium text-xs md:text-sm w-[15%] md:w-[15%]">
                                        <?php echo e($p->mc_score_str ?? '-'); ?>

                                    </td>

                                    <!-- Essay Score -->
                                    <td class="py-2.5 px-3 md:py-3 md:px-6 text-center text-[#0D2B70] font-medium text-xs md:text-sm w-[15%] md:w-[15%]">
                                        <?php echo e($p->essay_score_str ?? '-'); ?>
                                    ...
                                    <td class="py-2.5 px-3 md:py-3 md:px-6 text-center w-[20%]">
                                        <div class="inline-flex items-center gap-1 md:gap-2 text-[#0D2B70] font-medium text-xs md:text-sm">
                                            ...
                                            ?>
                                            <i class="fa-solid fa-circle text-xs" style="color: <?php echo e($color); ?>"></i>
                                            <span><?php echo e($p->status ?? 'Pending'); ?></span>
                                        </div>
                                    </td>
                                    ...
                                    <!-- Action Button -->
                                     <td class="py-2.5 px-3 md:py-3 md:px-6 text-center">
                                        ...
                                        <div class="inline-flex flex-row flex-nowrap items-center justify-center gap-2">
                                            <a href="<?php echo e(route('admin.view_exam', ['vacancy_id' => $p->vacancy_id, 'user_id' => $p->user_id])); ?>?batch=<?php echo e($activeBatch); ?>" target="_blank"
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-3 h-3 md:w-4 md:h-4']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                                            ...
                                            <button type="button"
                                                onclick="toggleApplicantPause(<?php echo e($p->user_id); ?>)"
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                                                <span><?php echo e(!empty($p->exam_paused_at) ? 'Resume' : 'Pause'); ?></span>
                                            </button>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($resumeAction['can_resume'])): ?>
                                                <button
                                                    type="button"
                                                    onclick="triggerResumeExamConfirm(<?php echo e($p->user_id); ?>)"
                                                    title="Resume exam with <?php echo e($resumeAction['remaining_label'] ?? 'saved'); ?> remaining"
                                    ...
                                    <!-- <td class="py-3 px-3 md:py-4 md:px-6 text-center w-[25%]">
                                        <button target="_blank" onclick="window.location.href='<?php echo e(route('admin.view_exam', ['vacancy_id' => $p->vacancy_id, 'user_id' => $p->user_id])); ?>'"
                                            class="text-[#0D2B70] border border-[#0D2B70] font-bold py-1.5 px-3 md:py-2 md:px-6 rounded-md text-xs md:text-sm
                                                transition-all duration-150 ease-[cubic-bezier(0.4,0,0.2,1)]
        ...
        <div class="w-full lg:w-[30%] lg:min-w-[320px] flex flex-col mt-4 lg:mt-0 pl-2 overflow-y-auto">
            ...
            <div id="panel-schedule" class="flex flex-col gap-3 hidden">
                <span class="text-xl text-[#0D2B70] font-bold border-b border-gray-200 pb-2 mb-1">
                    <?php echo e($showQualifiedWorkflow ? 'Schedule Exam' : 'Attendance Batch Schedule'); ?>
                ...
                <div class="flex flex-col">
                    ...
                    <input type="text" id="venue" name="place" required
                        value="<?php echo e($examDetails->place ?? ''); ?>"
                        <?php echo e(($isExamActive || $isExamCompleted || ($examDetails && $examDetails->details_saved)) ? 'disabled' : ''); ?>
                ...
                <div class="grid grid-cols-2 gap-2">
                    <div class="flex flex-col">
                        ...
                        <input type="date" id="date" name="date" required
                            value="<?php echo e($examDetails->date ?? ''); ?>"
                            <?php echo e(($isExamActive || $isExamCompleted || ($examDetails && $examDetails->details_saved)) ? 'disabled' : ''); ?>
                    ...
                    <div class="flex flex-col">
                        ...
                        <input class="font-sm h-full" type="time" id="time" name="time" required
                            value="<?php echo e($examDetails->time ?? ''); ?>"
                            <?php echo e(($isExamActive || $isExamCompleted || ($examDetails && $examDetails->details_saved)) ? 'disabled' : ''); ?>
                ...
                <div class="flex flex-col">
                    ...
                    <textarea id="message" name="message" rows="3" required
                        ...
                        placeholder="Enter message for applicants"><?php echo e($examDetails->message ?? ''); ?></textarea>
                </div>

                <input type="hidden" id="time_end_hidden" name="time_end" value="<?php echo e($examDetails->time_end ?? ''); ?>">
                <input type="hidden" id="duration" name="duration" value="<?php echo e($examDetails->duration ?? ''); ?>">

                <div class="flex flex-col gap-2 mt-4">
                    <div class="flex flex-col">
                        <div>
                            <button type="submit" id="saveNotifyButton" name="action" value="save_notify" 
                                    <?php echo e(($isExamActive || $isExamCompleted || ($examDetails && $examDetails->details_saved) || ($qualifiedCount < 1)) ? 'disabled' : ''); ?>
                        ...
                        <div>
                            <p id="scheduleNotifyMeta" class="text-xs text-gray-600 italic text-left mt-1 <?php echo e($scheduleNotifiedAt ? '' : 'hidden'); ?>">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($scheduleNotifiedAt): ?>
                                    Sent by: <b id="scheduleNotifySender"><?php echo e($scheduleNotifiedByName ?? 'An admin'); ?></b>
                                    on <b id="scheduleNotifyTime"><?php echo e(\Carbon\Carbon::parse($scheduleNotifiedAt)->format('M d, h:i A')); ?></b>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </p>
                        </div>
                    </div>
            ...
            <div id="panel-monitor" class="flex flex-col gap-3 hidden">
                ...
                <div class="grid grid-cols-2 gap-2">
                    <div class="flex flex-col">
                        ...
                        <input type="text" id="monitor_start" readonly
                            value="<?php echo e(!empty($examDetails->time) ? \Carbon\Carbon::createFromFormat('H:i:s', strlen($examDetails->time) === 5 ? $examDetails->time . ':00' : $examDetails->time)->format('g:i A') : '--:--'); ?>"
                    ...
                    <div class="flex flex-col">
                        ...
                        <input type="time" id="monitor_end" 
                            value="<?php echo e($examDetails->time_end ?? ''); ?>"
                            <?php echo e(($isExamActive || $isExamCompleted) ? 'disabled' : ''); ?>
                ...
                <div class="flex flex-col gap-2 mt-4">
                    <button type="button" id="openMonitorRecipientModalButton" onclick="openMonitorRecipientModal()"
                            <?php echo e(($qualifiedCount < 1 || $examDetails->link_sent || $isExamActive || $isExamCompleted || !$isExamDay || ($willAttendCount < 1)) ? 'disabled' : ''); ?>

                            title="<?php echo e($qualifiedCount < 1 ? 'No qualified applicants are available yet.' : 'Choose which applicants should receive exam links.'); ?>"
                            class="w-full py-2 bg-white border-2 border-[#0D2B70] rounded-lg text-[#0D2B70] font-bold text-sm hover:scale-[1.02] flex items-center justify-center gap-2 transition-transform disabled:opacity-50 disabled:hover:scale-100">
                        <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                    ...
                    <button type="button" id="sendLinkButton" onclick="triggerSendLinkConfirm('<?php echo e($vacancy->vacancy_id); ?>')" 
                            <?php echo e((!$examDetails || !$examDetails->details_saved || $examDetails->link_sent || $isExamActive || $isExamCompleted || !$isExamDay || ($willAttendCount < 1)) ? 'disabled' : ''); ?>

                            title="<?php echo e($willAttendCount < 1 ? 'No applicants are marked as Will Attend yet.' : 'Send exam links to applicants marked as Will Attend.'); ?>"
                            class="w-full py-2 bg-[#0D2B70] border-2 border-[#0D2B70] rounded-lg text-white font-bold text-sm hover:scale-[1.02] flex items-center justify-center gap-2 transition-transform disabled:opacity-50 disabled:hover:scale-100">
                        Send Link via Email
                    </button>
                    <p id="sendLinkMeta" class="text-xs text-gray-600 italic text-left mt-1 <?php echo e($linkSentAt ? '' : 'hidden'); ?>">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($linkSentAt): ?>
                            Sent by: <b id="sendLinkSender"><?php echo e($linkSentByName ?? 'An admin'); ?></b>
                            on <b id="sendLinkTime"><?php echo e(\Carbon\Carbon::parse($linkSentAt)->format('M d, h:i A')); ?></b>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </p>
                    
                    <button type="button" id="startExamButton" onclick="triggerStartExamConfirm('<?php echo e($vacancy->vacancy_id); ?>')" 
                            <?php echo e((!$examDetails || !$examDetails->link_sent || $isExamActive || $isExamCompleted || !$isExamDay || !$hasQuestions || ($lobbyCount < 1)) ? 'disabled' : ''); ?>
            ...
            <div id="panel-attendance" class="flex flex-col gap-3 hidden">
                ...
                <div class="grid gap-3">
                    <div class="rounded-xl border border-slate-200 bg-slate-50 px-4 py-4">
                        ...
                        <p id="attendanceResponsesCount" class="mt-2 text-3xl font-bold text-[#0D2B70]"><?php echo e($attendanceCount); ?></p>
                    </div>
                    <div class="rounded-xl border border-green-200 bg-green-50 px-4 py-4">
                        ...
                        <p id="attendanceWillAttendCount" class="mt-2 text-3xl font-bold text-green-800"><?php echo e($willAttendCount); ?></p>
                    </div>
                    <div class="rounded-xl border border-red-200 bg-red-50 px-4 py-4">
                        ...
                        <p id="attendanceWillNotAttendCount" class="mt-2 text-3xl font-bold text-red-800"><?php echo e($attendanceCount - $willAttendCount); ?></p>
                    </div>
                </div>
            </div>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-4 h-4 transform rotate-90']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
                        ...
                        <div class="max-h-[48vh] overflow-auto">
                            <table class="w-full table-fixed border-collapse text-left">
                                ...
                                <tbody id="monitor-recipient-list" class="divide-y divide-slate-200">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $qualifiedApplicants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $applicant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                        <tr class="text-[#0D2B70] hover:bg-slate-50 transition-colors duration-150">
                                            <td class="py-3 px-4">
                                                <input type="checkbox" value="<?php echo e($applicant['id']); ?>"
                                                    data-user-id="<?php echo e($applicant['user_id']); ?>"
                                                    data-can-receive-link="<?php echo e($applicant['can_receive_exam_link'] ? '1' : '0'); ?>"
                                                    <?php echo e($applicant['can_receive_exam_link'] ? '' : 'disabled'); ?>

                                                    onchange="updateSelectedCount()"
                                                    title="<?php echo e($applicant['can_receive_exam_link'] ? 'Eligible to receive exam link' : 'Only applicants marked as Will Attend can receive the exam link'); ?>"
                                            ...
                                            <td class="py-3 px-4 font-semibold truncate"><?php echo e($applicant['name']); ?></td>
                                            <td class="py-3 px-4 text-center">
                                                <span class="inline-flex items-center justify-center rounded-full px-3 py-1 text-xs font-semibold <?php echo e($applicant['attendance_badge_class']); ?>">
                                                    <?php echo e($applicant['attendance_label']); ?>

                                                </span>
                                            </td>
                                            <td class="py-3 px-4 text-center">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($applicant['is_read']): ?>
                                                ...
                                                <?php elseif($applicant['link_sent']): ?>
                                                ...
                                                <?php elseif($applicant['can_receive_exam_link']): ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Save & Notify Applicants','message' => 'Save exam details and notify qualified applicants?','event' => 'open-save-notify-confirm','confirm' => 'confirm-save-notify']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\App\View\Components\ConfirmModal::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Send Exam Links','message' => 'Send exam lobby links to all applicants marked as Will Attend?','event' => 'open-send-link-confirm','confirm' => 'confirm-send-link']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\App\View\Components\ConfirmModal::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Start Exam','message' => 'Start the exam now? All ready participants will enter the exam.','event' => 'open-start-exam-confirm','confirm' => 'confirm-start-exam']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\App\View\Components\ConfirmModal::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Resume Exam','message' => 'Reopen this applicant\'s submitted exam attempt from saved progress and restore the remaining time? Use this when a submission happened accidentally.','event' => 'open-resume-exam-confirm','confirm' => 'confirm-resume-exam','confirmText' => 'Resume','tone' => 'success']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
?>
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($examRealtimeEnabled): ?>
...
<script>
    ...
    function resumeApplicantExam(userId) {
        fetch(`/admin/exam_management/<?php echo e($vacancy->vacancy_id); ?>/resume/${userId}?${batchQuery}`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
    ...
    document.getElementById('examDetailsForm').addEventListener('submit', function(e) {
        ...
        const vacancyId = '<?php echo e($vacancy->vacancy_id); ?>';
    ...
    const qualifiedCount = <?php echo json_encode(isset($qualifiedApplicants) ? $qualifiedApplicants->count() : 0, 15, 512) ?>;
    const initialQualifiedApplicants = <?php echo json_encode(isset($qualifiedApplicants) ? $qualifiedApplicants->values() : [], 15, 512) ?>;
    const currentAdminDisplayName = <?php echo json_encode(optional(auth('admin')->user())->name ?? optional(auth('admin')->user())->email ?? 'An admin', 15, 512) ?>;
    let attendanceResponseCountClient = <?php echo json_encode(isset($attendanceApplicants) ? $attendanceApplicants->count() : 0, 15, 512) ?>;
    let willAttendCountClient = <?php echo json_encode(isset($attendanceApplicants) ? $attendanceApplicants->where('attendance_status', 'will_attend')->count() : 0, 512) ?>;
    let currentLobbyCount = <?php echo json_encode(count($participants ?? []), 15, 512) ?>;
    let hasExamDetailsClient = <?php echo json_encode(!is_null($examDetails ?? null), 15, 512) ?>;
    let detailsSavedClient = <?php echo json_encode($examDetails && $examDetails->details_saved, 15, 512) ?>;
    const linkSentConst = <?php echo json_encode($examDetails && $examDetails->link_sent, 15, 512) ?>;
    let linkSentClient = linkSentConst;
    let examPausedClient = <?php echo json_encode((bool) ($examDetails?->exam_paused_at ?? false), 15, 512) ?>;
    let examPauseResumeCountdownTimer = null;
    let examPauseActionInProgress = false;
    const isExamActiveConst = <?php echo json_encode($isExamActive, 15, 512) ?>;
    const isExamCompletedConst = <?php echo json_encode($isExamCompleted, 15, 512) ?>;
    const isExamDayConst = <?php echo json_encode($isExamDay, 15, 512) ?>;
    const hasQuestionsConst = <?php echo json_encode($hasQuestions ?? false, 15, 512) ?>;
        ...
        if (examPausedClient) {
            ...
            examPauseResumeCountdownTimer = window.setInterval(() => {
                ...
                if (secondsRemaining <= 0) {
                    ...
                    fetch(`/admin/exam_management/<?php echo e($vacancy->vacancy_id); ?>/pause?${batchQuery}`, {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
    ...
    function toggleApplicantPause(userId) {
        fetch(`/admin/exam_management/<?php echo e($vacancy->vacancy_id); ?>/pause/${userId}?${batchQuery}`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
    ...
    function handleEditClick(e) {
        e.preventDefault();
        const isExamActive = <?php echo json_encode($isExamActive, 15, 512) ?>;
        const isExamCompleted = <?php echo json_encode($isExamCompleted, 15, 512) ?>;
        ...
        window.location.href = '<?php echo e(route('admin.exam.edit', $vacancy->vacancy_id)); ?>?batch=' + encodeURIComponent(selectedBatch);
    }
    ...
    function overrideAttendanceStatus(userId, attendanceStatus, existingRemark = '') {
        ...
        fetch(`/admin/exam_management/<?php echo e($vacancy->vacancy_id); ?>/attendance/${userId}?${batchQuery}`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
    ...
    function notifySelected() {
        ...
        fetch(`/admin/exam_management/<?php echo e($vacancy->vacancy_id); ?>/notify-selected?${batchQuery}`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
    ...
    function fetchQualifiedApplicants(search = '') {
        ...
        fetch(`/admin/exam_management/<?php echo e($vacancy->vacancy_id); ?>/qualified?${params.toString()}&${batchQuery}`, {
            headers: { 
    ...
    function refreshMonitorRecipients() {
        fetch(`/admin/exam_management/<?php echo e($vacancy->vacancy_id); ?>/qualified?${batchQuery}`, {
            headers: {
                'X-Requested-With': 'XMLHttpRequest',
                'Accept': 'application/json'
            }
    ...
    function fetchAttendanceApplicants() {
        ...
        attendanceFetchInFlight = fetch(`/admin/exam_management/<?php echo e($vacancy->vacancy_id); ?>/attendance-data?${batchQuery}`, {
            headers: {
                'X-Requested-With': 'XMLHttpRequest',
                'Accept': 'application/json'
            },
    ...
    // LOBBY POLLING & AJAX
    // ========================================
    const vacancyId = <?php echo json_encode($vacancy->vacancy_id, 15, 512) ?>;
    const selectedBatch = <?php echo json_encode((int) ($selectedBatch ?? request('batch', 1)), 512) ?>;
    const showQualifiedWorkflow = <?php echo json_encode((bool) ($showQualifiedWorkflow ?? false), 15, 512) ?>;
    const batchQuery = `batch=${encodeURIComponent(selectedBatch)}`;

    if (!showQualifiedWorkflow) {
        switchTab('attendance');
    }
    const examRealtimeConfig = <?php echo json_encode($examRealtimeConfig, 15, 512) ?>;
...
<?php echo $__env->make('layout.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\DILG-CAR\resources\views/admin/manage_exam.blade.php ENDPATH**/ ?>