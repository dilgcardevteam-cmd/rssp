<?php $__env->startSection('title', 'Learning and Development'); ?>
<style>
    body {
...
?>
<form id="learning-form" class="space-y-8" action="<?php echo e(route('submit_c3', $c3RouteParams)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->boolean('simple')): ?>
            ...
            <div class="flex flex-col sm:flex-row justify-between items-center mt-8 gap-4">
                <button type="button" onclick="window.location.href='<?php echo e(route('display_c2', ['simple' => 1])); ?>'"
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        let data_otherInfo = <?php echo json_encode($data_otherInfo); ?>;
        ...
        const learningData = <?php echo json_encode($data_learning, 15, 512) ?>;
...
<div class="entry-card bg-gray-50 rounded-lg p-4 sm:p-6 card-hover animate-fade-in">
    ...
    <div class="grid grid-cols-1 gap-4">
        ...
        const voluntaryData = <?php echo json_encode($data_voluntary, 15, 512) ?>;
...
<script>
    (function () {
        ...
        const autosaveUrl = <?php echo json_encode(route('pds.autosave', ['section' => 'c3']), 512) ?>;
...
<?php echo $__env->make('layout.pds_layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\rhrmspb\resources\views/pds/c3.blade.php ENDPATH**/ ?>