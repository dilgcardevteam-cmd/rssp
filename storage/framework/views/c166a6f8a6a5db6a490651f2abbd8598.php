...
<main class="w-full h-full min-h-0 flex flex-col gap-4 overflow-hidden pb-4">
                ...
                <tbody id="vacancy-list" class="divide-y divide-[#0D2B70]">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $vacancies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vacancy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        ...
                        <tr class="text-sm text-[#0D2B70] select-none hover:bg-blue-50 transition-colors duration-200">
                            <td class="w-[15%] px-3 py-2"><?php echo e($vacancy->vacancy_id); ?></td>

                            <td class="w-[30%] px-3 py-2">
                                <p class="font-medium"><?php echo e($vacancy->position_title); ?></p>
                                <p class="mt-0.5 text-xs italic text-[#0D2B70]/70">
                                    <?php echo e($vacancyTypeLabel); ?>
                            ...
                            <td class="w-[15%] px-3 py-2 text-left">
                                <div class="flex items-center justify-start gap-1.5 font-normal">
                                    ...
                                    <span class="inline-block h-2.5 w-2.5 rounded-full <?php echo e($statusColor); ?>"></span>
                            ...
                            <td class="w-[40%] px-3 py-2 text-center">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="<?php echo e(route('admin.manage_applicants', ['vacancy_id' => $vacancy->vacancy_id])); ?>?tab=new"
                                    ...
                                    <span>New</span>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($vacancy->pending_count) && $vacancy->pending_count > 0): ?>
                                    ...
                                    <a href="<?php echo e(route('admin.manage_applicants', ['vacancy_id' => $vacancy->vacancy_id])); ?>?tab=compliance"
                                    class="relative group use-loader inline-flex h-8 w-24 items-center justify-center rounded-md border border-[#0D2B70] text-xs font-bold text-[#0D2B70] transition-all duration-300 hover:scale-105 hover:bg-[#0D2B70] hover:text-white hover:shadow-md">
                                    <span>Compliance</span>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($vacancy->compliance_count) && $vacancy->compliance_count > 0): ?>
                                        <span class="absolute -right-2 -top-2 z-10 flex h-4 w-4 items-center justify-center rounded-full border border-white bg-orange-500 text-[9px] font-bold text-white shadow-sm">
                                            <?php echo e($vacancy->compliance_count); ?>

                                        </span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </a>
                                    <a href="<?php echo e(route('admin.manage_applicants', ['vacancy_id' => $vacancy->vacancy_id])); ?>?tab=qualified"
                                    class="relative group use-loader inline-flex h-8 w-24 items-center justify-center rounded-md border border-[#0D2B70] text-xs font-bold text-[#0D2B70] transition-all duration-300 hover:scale-105 hover:bg-[#0D2B70] hover:text-white hover:shadow-md">
                                    <span>Qualified</span>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($vacancy->qualified_count) && $vacancy->qualified_count > 0): ?>
                                        <span class="absolute -right-2 -top-2 z-10 flex h-4 w-4 items-center justify-center rounded-full border border-white bg-green-600 text-[9px] font-bold text-white shadow-sm">
                                            <?php echo e($vacancy->qualified_count); ?>

                                        </span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </a>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isPlantillaVacancy): ?>
                                        <a href="<?php echo e(route('admin.manage_applicants', ['vacancy_id' => $vacancy->vacancy_id])); ?>?tab=no-pqe"
                                        class="relative group use-loader inline-flex h-8 w-24 items-center justify-center rounded-md border border-[#0D2B70] text-xs font-bold text-[#0D2B70] transition-all duration-300 hover:scale-105 hover:bg-[#0D2B70] hover:text-white hover:shadow-md">
                                        <span>No PQE</span>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($vacancy->no_pqe_count) && $vacancy->no_pqe_count > 0): ?>
                                            <span class="absolute -right-2 -top-2 z-10 flex h-4 w-4 items-center justify-center rounded-full border border-white bg-slate-600 text-[9px] font-bold text-white shadow-sm">
                                                <?php echo e($vacancy->no_pqe_count); ?>
    ...
    <script>
        ...
        const applicationsListUrl = <?php echo json_encode(route('applications_list'), 15, 512) ?>;
        const hrAccessStateUrl = <?php echo json_encode(route('admin.applications_list.access_state'), 15, 512) ?>;
        const isHrDivisionUser = <?php echo json_encode($isHrDivisionUser ?? false, 15, 512) ?>;
        let latestHrAccessSignature = <?php echo json_encode($accessSignature ?? '', 15, 512) ?>;
...
<?php echo $__env->make('layout.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\DILG-CAR\resources\views/admin/applications_list.blade.php ENDPATH**/ ?>