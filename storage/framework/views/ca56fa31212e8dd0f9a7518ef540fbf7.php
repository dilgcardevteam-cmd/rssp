...
<?php $__env->startSection('title', 'Exam Library'); ?>
<?php $__env->startSection('content'); ?>
    ...
    <main class="w-full min-h-screen flex flex-col space-y-6 p-6">
        ...
        <div id="series-grid" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $series; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                <div class="bg-white rounded-xl shadow-lg p-6 border border-gray-200 hover:shadow-xl transition-all duration-200 cursor-pointer"
                    onclick="viewSeries(<?php echo e($item->id); ?>)">
                    <div class="flex justify-between items-start mb-4">
                        <h3 class="text-xl font-bold text-[#0D2B70] flex-1"><?php echo e($item->series_name); ?></h3>
                        <div class="flex gap-2">
                            <button onclick="event.stopPropagation(); editSeries(<?php echo e($item->id); ?>)"
                            ...
                            <button onclick="event.stopPropagation(); deleteSeries(<?php echo e($item->id); ?>)"
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->description): ?>
                        <p class="text-gray-600 text-sm mb-4 line-clamp-2"><?php echo e($item->description); ?></p>
                    ...
                    <div class="flex items-center justify-between text-sm text-gray-500 border-t pt-4">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="font-semibold"><?php echo e($item->questions_count); ?> Questions</span>
                        </div>
                        <span class="text-xs"><?php echo e($item->created_at->diffForHumans()); ?></span>
                    </div>
                </div>
    ...
    <script>
        let allSeries = <?php echo json_encode($series, 15, 512) ?>;
...
<?php echo $__env->make('layout.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\DILG-CAR\resources\views/admin/exam_library/index.blade.php ENDPATH**/ ?>