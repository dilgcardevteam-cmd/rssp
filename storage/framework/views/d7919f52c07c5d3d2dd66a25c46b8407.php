<?php $__env->startSection('title', 'DILG - Edit Exam'); ?>
...
<?php $__env->startSection('content'); ?>
    <div id="examEditorRoot" x-data="examEditor()" class="w-full max-w-full font-montserrat">
        ...
        <section class="flex items-center space-x-4 mb-4 max-w-full border-b border-[#0D2B70]">
            <!-- BACK BUTTON -->
            <button aria-label="Back" @click.prevent="handleBackClick('<?php echo e(route('admin.manage_exam', $vacancy_id)); ?>?batch=<?php echo e((int) ($selectedBatch ?? request('batch', 1))); ?>')"
        ...
        <div class="flex flex-row justify-between items-center gap-2">
            <span class="text-[#0D2B70] text-2xl font-montserrat whitespace-nowrap"><?php echo e($vacancy->position_title); ?>,
                <?php echo e($vacancy->vacancy_type); ?> position</span>
        ...
        <form method="POST" id="examForm" @submit.prevent="handleSaveClick"
            action="<?php echo e(route('admin.exam.update', $vacancy_id)); ?>">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="questions" :value="JSON.stringify(questions)">
            <input type="hidden" name="batch" value="<?php echo e((int) ($selectedBatch ?? request('batch', 1))); ?>">
    ...
    <script>
        ...
        function examEditor() {
            return {
                ...
                init() {
                        const data = <?php echo json_encode($exam_items, 15, 512) ?>;
                ...
                getDraftStorageKey() {
                    return 'examEditorDraft_<?php echo e($vacancy_id); ?>_batch_<?php echo e((int) ($selectedBatch ?? request('batch', 1))); ?>';
                },
                ...
                persistDraftToStorage() {
                    try {
                        ...
                        localStorage.setItem(this.getDraftStorageKey(), JSON.stringify({
                            vacancy_id: '<?php echo e($vacancy_id); ?>',
                            batch: '<?php echo e((int) ($selectedBatch ?? request('batch', 1))); ?>',
                ...
                openExamLibrary() {
                    ...
                    window.location.href = "<?php echo e(url('/admin/exam-library/select')); ?>?return=<?php echo e(urlencode(url()->current() . '?batch=' . ((int) ($selectedBatch ?? request('batch', 1))))); ?>";
                },
...
<?php echo $__env->make('layout.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\DILG-CAR\resources\views/admin/exam_edit.blade.php ENDPATH**/ ?>