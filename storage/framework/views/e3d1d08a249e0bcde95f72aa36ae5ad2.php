<?php $__env->startSection('title', 'DILG - Admin Exam Management'); ?>
...
<main class="w-full h-full min-h-0 flex flex-col gap-4 overflow-hidden">
                ...
                <div class="flex w-full flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                    <div class="grid w-full gap-3 md:grid-cols-4">
                        ...
                        <div>
                            ...
                            <select id="jobTypeFilter"
                                    <?php echo e($isViewerMode ? 'disabled' : ''); ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isViewerMode): ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isViewerMode): ?>
                        <div class="shrink-0 lg:pl-2">
                            <button onclick="window.location.href='<?php echo e(route('admin.exam_library')); ?>'" type="button"
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-blue-50 transition-colors duration-200">
                            ...
                            <td class=" px-6 text-center text-[#0D2B70] w-[20%]">
                                <?php echo e($vacancy->vacancy_type); ?>
                            ...
                            <td class=" px-6 text-center w-[15%]">
                                ...
                                ?>
                                <span class="inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-bold <?php echo e($statusClass); ?>">
                            ...
                            <td class=" px-6 text-center w-[15%]">
                                ...
                                <button 
                                    <?php if($canMonitor): ?>
                                        onclick="window.location.href='<?php echo e(route('admin.manage_exam', $vacancy->vacancy_id)); ?>'"
                                    <?php else: ?>
                                        disabled
                                    <?php endif; ?>
                                    class="text-[#0D2B70] border border-[#0D2B70] font-bold py-2 px-6 rounded-md text-sm
                                    transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)]
                                    <?php echo e($canMonitor ? 'hover:scale-105 hover:bg-[#0D2B70] hover:text-white hover:shadow-md' : 'opacity-50 cursor-not-allowed'); ?>"
                                >
                                    <?php echo e($isViewerMode ? 'Monitor' : 'Manage'); ?>

                                </button>
                            </td>
                        </tr>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($vacancies->isEmpty()): ?>
                        <tr>
    ...
    <script>
        const isViewerMode = <?php echo json_encode($isViewerMode, 15, 512) ?>;
...
<?php echo $__env->make('layout.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\DILG-CAR\resources\views/admin/exam_management.blade.php ENDPATH**/ ?>