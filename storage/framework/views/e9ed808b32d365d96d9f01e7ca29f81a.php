...
<?php $__env->startSection('title', 'DILG - Job Vacancies Management'); ?>
    ...
    <section x-data="{ filtersOpen: true, actionsMenuOpen: false }" class="flex-none mt-1 w-full rounded-2xl border border-slate-200 bg-white p-4 shadow-sm lg:p-5">
        <div class="flex items-center justify-between gap-3">
            ...
            <div class="flex items-center gap-2">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (! ($isHrDivisionUser)): ?>
                    ...
                    >
                        <div class="grid gap-2">
                            <div x-data="{ open: false }" class="relative min-w-0">
                                ...
                                >
                                    <a href="<?php echo e(route('downloadCOSTemplate')); ?>" class="block px-4 py-2 text-sm font-semibold text-[#0D2B70] hover:bg-gray-100">
                                        Download COS template
                                    </a>
                                    <a href="<?php echo e(route('downloadPlantillaTemplate')); ?>" class="block px-4 py-2 text-sm font-semibold text-[#0D2B70] hover:bg-gray-100">
            ...
            <div class="flex w-full flex-col gap-4">
                <form class="relative w-full" onsubmit="return false;">
                    ...
                    <input
                        ...
                        aria-label="Search"
                        value="<?php echo e(session('vacancyFilterSearch')); ?>"
                    ...
                    <div class="grid flex-1 gap-2 sm:grid-cols-2 xl:grid-cols-3">
                        ...
                        <div x-data="{ jobOpen: false }" data-filter-dropdown="job" class="relative min-w-0">
                            ...
                            <select id="jobFilter" class="hidden">
                                ...
                                <?php else: ?>
                                    <option value="" <?php echo e(session('vacancyFilterJob') == '' ? 'selected' : ''); ?>>All</option>
                                    <option value="COS" <?php echo e(session('vacancyFilterJob') == 'COS' ? 'selected' : ''); ?>>Contract of Service</option>
                                    <option value="Plantilla" <?php echo e(session('vacancyFilterJob') == 'Plantilla' ? 'selected' : ''); ?>>PLANTILLA</option>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </select>
                            ...
                            >
                                ...
                                <?php else: ?>
                                    <button
                                        ...
                                        class="block w-full px-4 py-2 text-left text-sm font-semibold text-[#0D2B70] hover:bg-gray-100 <?php echo e(session('vacancyFilterJob') == '' ? 'bg-gray-100' : ''); ?>"
                                    >
                                        All
                                    </button>
                                    <button
                                        onclick="document.getElementById('jobFilter').value = 'COS'; document.getElementById('jobFilter').dispatchEvent(new Event('change')); fetchVacancies();"
                                        @click="jobOpen = false; $el.closest('.relative').querySelector('button span span').innerText = 'Contract of Service'"
                                        class="block w-full px-4 py-2 text-left text-sm font-semibold text-[#0D2B70] hover:bg-gray-100 <?php echo e(session('vacancyFilterJob') == 'COS' ? 'bg-gray-100' : ''); ?>"
                                    >
                                        Contract of Service
                                    </button>
                                    <button
                                        ...
                                        class="block w-full px-4 py-2 text-left text-sm font-semibold text-[#0D2B70] hover:bg-gray-100 <?php echo e(session('vacancyFilterJob') == 'Plantilla' ? 'bg-gray-100' : ''); ?>"
                                    >
                                        PLANTILLA
                                    </button>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <!-- Status Filter -->
                        <div x-data="{ statusOpen: false, selectedStatus: '<?php echo e(session('vacancyFilterStatus') ?: 'All'); ?>' }" data-filter-dropdown="status" class="relative min-w-0">
                            <button
                                type="button"
                            ...
                            <select id="statusFilter" class="hidden">
                                <option value="" <?php echo e(session('vacancyFilterStatus') == '' ? 'selected' : ''); ?>>All</option>
                                <option value="OPEN" <?php echo e(session('vacancyFilterStatus') == 'OPEN' ? 'selected' : ''); ?>>OPEN</option>
                                <option value="CLOSED" <?php echo e(session('vacancyFilterStatus') == 'CLOSED' ? 'selected' : ''); ?>>CLOSED</option>
                            </select>
                        ...
                        <!-- Place Filter -->
                        <div x-data="{ placeOpen: false, selectedPlace: '<?php echo e(session('vacancyFilterPlace') ?: 'All Places'); ?>' }" data-filter-dropdown="place" class="relative min-w-0">
                            <button
                                type="button"
                            ...
                            <select id="placeFilter" class="hidden">
                                <option value="" <?php echo e(session('vacancyFilterPlace') == '' ? 'selected' : ''); ?>>All Places</option>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $placeOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $placeOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <option value="<?php echo e($placeOption); ?>" <?php echo e(session('vacancyFilterPlace') == $placeOption ? 'selected' : ''); ?>><?php echo e($placeOption); ?></option>
                            ...
                            >
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $placeOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $placeOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <button
                                        onclick="document.getElementById('placeFilter').value = '<?php echo e($placeOption); ?>'; document.getElementById('placeFilter').dispatchEvent(new Event('change')); fetchVacancies();"
                                        @click="placeOpen = false; selectedPlace = '<?php echo e($placeOption); ?>'"
                                        class="block w-full px-4 py-2 text-left text-sm font-semibold text-[#0D2B70] hover:bg-gray-100"
                                        :class="{ 'bg-gray-100': selectedPlace === '<?php echo e($placeOption); ?>' }"
                                    >
                                        <?php echo e($placeOption); ?>
                    ...
                    <div class="xl:w-[220px] xl:pl-1">
                        <div x-data="{ open: false }" class="relative min-w-0">
                            ...
                            <div
                                ...
                                class="absolute left-0 z-50 mt-2 w-full min-w-[190px] rounded-xl border border-gray-200 bg-white shadow-lg sm:left-auto sm:right-0"
                            >
                                <a href="<?php echo e(route('vacancies.addcos')); ?>" class="use-loader block px-4 py-2 text-sm font-semibold text-[#0D2B70] hover:bg-gray-100">
                                    Add COS Vacancy
                                </a>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (! ($isHrDivisionUser)): ?>
                                    <a href="<?php echo e(route('vacancies.addplantilla')); ?>" class="use-loader block px-4 py-2 text-sm font-semibold text-[#0D2B70] hover:bg-gray-100">
            ...
            <table class="w-full text-left border-collapse table-fixed">
                <tbody id="vacancy-list" class="divide-y divide-[#0D2B70]">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $vacancies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vacancy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <?php echo $__env->make('partials.admin_job_vacancy_card', ['vacancy' => $vacancy, 'index' => $loop->index], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php echo $__env->make('layout.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\DILG-CAR\resources\views/admin/vacancies_management.blade.php ENDPATH**/ ?>