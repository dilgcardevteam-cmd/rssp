        ...
        <div class="mx-auto w-full max-w-lg">
          ...
          <div>
            ...
            <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-4" autocomplete="off">
              ...
              <div class="flex flex-col gap-2 pt-1 text-sm sm:flex-row sm:items-center sm:justify-between">
                <label class="inline-flex items-center gap-2 text-slate-600">
                  <input type="checkbox" name="remember" <?php echo e(old('remember') ? 'checked' : ''); ?> class="rounded border-slate-300 text-[#0D2B70] focus:ring-[#0D2B70]/30">
                  <span class="font-semibold">Remember me</span>
                </label>
                <a href="<?php echo e(route('forgot.password.form')); ?>" class="font-semibold text-[#0D2B70] hover:underline">Forgot Password?</a>
              </div>
            ...
            <div class="mt-5 border-t border-slate-200 pt-4">
              ...
              <!-- <a
                href="<?php echo e(route('google.login', [], false)); ?>"
              ...
              >
                <img src="<?php echo e(asset('images/google-icon.png')); ?>" alt="Google Icon" class="h-5 w-5">
                Continue with Google
              </a> -->

              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Route::has('register.form')): ?>
                <p class="mt-4 text-center text-sm text-slate-600">
                  Don't have an account?
                  <a href="<?php echo e(route('register.form')); ?>" class="use-loader font-semibold text-[#0D2B70] hover:underline">Create one here</a>
                </p>
              <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
          </div>
...
<?php /**PATH C:\xampp\htdocs\DILG-CAR\resources\views/login_register/login.blade.php ENDPATH**/ ?>