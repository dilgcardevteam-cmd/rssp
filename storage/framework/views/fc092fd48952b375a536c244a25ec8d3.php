...
<aside
    ...
    <div class="flex-1 overflow-y-auto scrollbar-thin">
        <a href="#" class="flex items-center gap-2 pt-14 px-2 cursor-pointer overflow-hidden">
            <img src="<?php echo e(asset('images/dilg_logo.png')); ?>" alt="DILG Logo"
        ...
        <nav class="mt-8 space-y-1 px-2 font-montserrat pb-4">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($adminRole, ['superadmin', 'admin', 'hr_division', 'viewer'], true)): ?>
                <a href="<?php echo e($adminRole === 'viewer' ? route('viewer') : route('dashboard_admin')); ?>" class="use-loader group flex items-center rounded-md px-4 py-2 text-sm font-bold transition-all duration-200
                        <?php echo e((request()->routeIs('dashboard_admin') || request()->routeIs('viewer'))
        ...
        : 'text-[#002C76] hover:text-white hover:bg-[#002C76] hover:shadow-md'); ?>">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($adminRole, ['superadmin', 'admin', 'hr_division'], true)): ?>
                <a href="<?php echo e(route('vacancies_management')); ?>" class="use-loader group flex items-center rounded-md px-4 py-2 text-sm font-bold transition-all duration-200
        ...
        : 'text-[#002C76] hover:text-white hover:bg-[#002C76] hover:shadow-md'); ?>">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($adminRole === 'hr_division'): ?>
                <a href="<?php echo e(route('admin.positions.index')); ?>" class="use-loader group flex items-center rounded-md px-4 py-2 text-sm font-bold transition-all duration-200
        ...
        : 'text-[#002C76] hover:text-white hover:bg-[#002C76] hover:shadow-md'); ?>">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($adminRole, ['superadmin', 'admin', 'hr_division'], true)): ?>
                <a href="<?php echo e(route('applications_list')); ?>" class="use-loader group flex items-center rounded-md px-4 py-2 text-sm font-bold transition-all duration-200
        ...
        : 'text-[#002C76] hover:text-white hover:bg-[#002C76] hover:shadow-md'); ?>">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($adminRole, ['superadmin', 'admin', 'viewer'], true)): ?>
                <a href="<?php echo e(route('admin_exam_management')); ?>" class="use-loader group flex items-center rounded-md px-4 py-2 text-sm font-bold transition-all duration-200
        ...
        : 'text-[#002C76] hover:text-white hover:bg-[#002C76] hover:shadow-md'); ?>">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($adminRole, ['superadmin', 'admin', 'viewer', 'hr_division'], true)): ?>
                <a href="<?php echo e(route('manual.admin')); ?>" class="use-loader group flex items-center rounded-md px-4 py-2 text-sm font-bold transition-all duration-200
        ...
        : 'text-[#002C76] hover:text-white hover:bg-[#002C76] hover:shadow-md'); ?>">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($adminRole === 'superadmin'): ?>
                <a href="<?php echo e(route('admin_account_management')); ?>" class="use-loader group flex items-center rounded-md px-4 py-2 text-sm font-bold transition-all duration-200
                ...
                <a href="<?php echo e(route('admin.applicant_records.index')); ?>" class="use-loader group flex items-center rounded-md px-4 py-2 text-sm font-bold transition-all duration-200
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($adminRole, ['superadmin', 'admin'], true)): ?>
                <?php
                    $utilitiesOpen = request()->routeIs('admin_activity_log')
                        ...
                        || $isProgramsContext;
                ?>
                <div x-data="{ submenuOpen: <?php echo e($utilitiesOpen ? 'true' : 'false'); ?> }" class="relative">
                    ...
                    <div x-show="submenuOpen" x-collapse data-utils-panel="desktop" data-initial-open="<?php echo e($utilitiesOpen ? '1' : '0'); ?>" class="pl-4 mt-1 space-y-1 overflow-hidden">
                        <a href="<?php echo e(route('signatories.index')); ?>" class="use-loader group flex items-center rounded-md px-4 py-2 text-sm font-bold transition-all duration-200 <?php echo e(request()->routeIs('signatories.*')
                                ? 'bg-[#002C76] text-white shadow-md'
                                : 'text-[#002C76] hover:text-white hover:bg-[#002C76] hover:shadow-md'); ?>">
                        ...
                        <a href="<?php echo e(route('admin.positions.index')); ?>" class="use-loader group flex items-center rounded-md px-4 py-2 text-sm font-bold transition-all duration-200 <?php echo e($isPositionsContext
                                ? 'bg-[#002C76] text-white shadow-md'
                                : 'text-[#002C76] hover:text-white hover:bg-[#002C76] hover:shadow-md'); ?>">
                        ...
                        <a href="<?php echo e(route('admin.courses.index')); ?>" class="use-loader group flex items-center rounded-md px-4 py-2 text-sm font-bold transition-all duration-200 <?php echo e($isProgramsContext
                                ? 'bg-[#002C76] text-white shadow-md'
                                : 'text-[#002C76] hover:text-white hover:bg-[#002C76] hover:shadow-md'); ?>">
                        ...
                        <a href="<?php echo e(route('admin_activity_log')); ?>" class="use-loader group flex items-center rounded-md px-4 py-2 text-sm font-bold transition-all duration-200
                        ...
                        <a href="<?php echo e(route('admin.reports.index')); ?>" class="use-loader group flex items-center rounded-md px-4 py-2 text-sm font-bold transition-all duration-200
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($adminRole === 'superadmin'): ?>
                            <a href="<?php echo e(route('admin.backup.index')); ?>" class="use-loader group flex items-center rounded-md px-4 py-2 text-sm font-bold transition-all duration-200
...
<?php /**PATH C:\xampp\htdocs\DILG-CAR\resources\views/partials/sidebar_admin.blade.php ENDPATH**/ ?>